...
hash_t pointer_hash(void const *e1, void const *extra) { return (unsigned long long)e1; }
...
const struct obj_typeclass const ptr_obj_typeclass_witness = { .hash = pointer_hash, NULL };
const struct equals_typeclass const ptr_equals_typeclass_witness = { .equal = pointer_equals, .not_equal = pointer_not_equals, NULL };
